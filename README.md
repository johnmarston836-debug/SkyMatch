...
- **Everyone else sees you as unreachable, not gone.** Three missed beats (35s) and a passenger is shown dimmed, with a red no-entry mark on their photo and "No connection · 3 min ago", below the people who are here; after ten minutes the radio forgets them, and they come back the moment their next beat arrives. This is what iOS phones look like when their owner leaves the app, and an Android phone that was disconnected or closed.
- **Saved chats stay in the list.** A conversation outlives the radio's memory of the person: `chatStore.contacts` keeps the name and seat they last had, so their chat stays in the list, at the bottom, with the same red mark and "No connection", and can still be read or deleted (swipe left).
